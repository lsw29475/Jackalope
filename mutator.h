...
public:
    ...
    virtual MutatorSampleContext *CreateSampleContext(Sample *sample)
    {
        return NULL;
    }
    ...
    virtual void AddMutator(Mutator *mutator)
    {
...
protected:
    ...
    template <typename T>
    void AddDefaultInterestingValues(std::vector<Sample> &interesting_values);

    template <typename T>
    T FlipEndian(T value)
    {
        T out = 0;
